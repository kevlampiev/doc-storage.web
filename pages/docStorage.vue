  ...
  <div class="ma">
    ...
    <div class="controlPanel">
      <div class="searchForm">
        <input class="searchForm__input" type="search" placeholder="Enter search string here..." />
    ...
    <div class="cardsContainer">
      <section class="card">
        <h2 class="card__header">Шкаф-купе большой</h2>
        <div class="card__description">
          Lorem ipsum dolor sit amet, consectetur adipisicing elit. Optio
          temporibus inventore perspiciatis asperiores. Pariatur error
          perferendis maiores explicabo officiis expedita!
        </div>
        <div class="card__itemsInfo">3 ящика</div>
      ...
      <section class="card">
        ...
        >Pariatur error perferendis maiores explicabo officiis expedita!</div>
...
.summaryBand {
  ...
  text-align: right;
  font-style: italic;
  //  clip-path: polygon(0% 0%, 0% 100%, 100% 100%, 100% 25%, 52% 25%, 48% 0%);
}
</style>
